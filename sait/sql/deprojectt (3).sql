...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 17, 2024 at 12:04 AM
...
(1, 1, 'car2', 'отклонено', '2004-01-10'),
(2, 2, 'car1', 'подтверждено', '2004-01-10'),
(3, 2, 'car2', 'подтверждено', '2004-01-10');
...
(4, 'Админ Админ Админ', 'car', 'carforme', 'admin@gmail.com', '8(222)-546-56-64', 'admin');
